...
if ($_GET['stype'] == "l") {
    if (isset($_POST['submit_link'])) {
        ...
        if (dbrows($result)) {
            ...
            echo "<td class='tbl'><input type='text' name='link_name' maxlength='100' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl'>" . $locale['423'] . "<span style='color:#ff0000'>*</span></td>\n";
            echo "<td class='tbl'><input type='text' name='link_url' value='http://' maxlength='200' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl'>" . $locale['424'] . "<span style='color:#ff0000'>*</span></td>\n";
            echo "<td class='tbl'><input type='text' name='link_description' maxlength='200' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
    ...
    if (isset($_POST['submit_news'])) {
        ...
        add_to_title($locale['global_200'] . $locale['450']);
        opentable("<span class='icon-newspaper'></span> " . $locale['450']);
        ...
        echo "<h5>" . $locale['471'] . "<span style='color:#ff0000'>*</span></h5>";
        echo "<input type='text' name='news_subject' value='$news_subject' maxlength='64' class='textbox'/>";

        echo "<h5>" . $locale['476'] . "</h5>";
    ...
    if (isset($_POST['submit_article'])) {
        ...
        if (dbrows($result)) {
            ...
            echo "<td class='tbl'><input type='text' name='article_subject' value='$article_subject' maxlength='64' class='textbox dummy_classname'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td valign='top' class='tbl'>" . $locale['523'] . "<span style='color:#ff0000'>*</span></td>\n";
            echo "<td class='tbl'><textarea name='article_snippet' cols='60' rows='3' class='textbox dummy_classname'>$article_snippet</textarea></td>\n";
            echo "</tr>\n";
            echo "<tr>\n<td class='tbl'></td>\n<td class='tbl'>\n";
            ...
            echo "<td class='tbl'><textarea name='article_body' cols='60' rows='8' class='textbox dummy_classname'>$article_body</textarea></td>\n";
            echo "</tr>\n";
            echo "<tr>\n<td class='tbl'></td>\n<td class='tbl'>\n";
    ...
    if (isset($_POST['submit_photo'])) {
        ...
        $opts = "";
        add_to_title($locale['global_200'] . $locale['570']);
        opentable("<span class='icon-image2'></span> " . $locale['570']);
        ...
        if (dbrows($result)) {
            ...
            echo "<h5>" . $locale['621'] . "<span style='color:#ff0000'>*</span></h5>";
            echo "<input type='text' name='photo_title' maxlength='100'  class='textbox'/>";
            echo "<h5>" . $locale['622'] . "<span style='color:#ff0000'>*</span></h5>";
            echo "<textarea name='photo_description' rows='5' class='textbox'></textarea>";
            echo "<h5>" . $locale['623'] . "<span style='color:#ff0000'>*</span></h5>";
            echo "<label><input type='file' name='photo_pic_file' class='textbox'/><br />\n";
            echo "<span class='small2'>" . sprintf($locale['624'], parsebytesize($settings['photo_max_b']), $settings['photo_max_w'], $settings['photo_max_h']) . "</span></label>";

            echo "<h5>" . $locale['625'] . "</h5>";
            echo "<select name='album_id' class='textbox'>\n$opts</select><br>";
            echo "<input type='submit' name='submit_photo' value='" . $locale['626'] . "' class='button center' />";
            echo "</form>";
        } else {
            echo "<div style='text-align:center'><br />\n" . $locale['552'] . "<br /><br />\n</div>\n";
        }
    ...
    if (isset($_POST['submit_download'])) {
        ...
        if (!$error) {
            ...
            echo "<div style='text-align:center'><br />\n" . $locale['670'] . "<br /><br />\n";
            switch ($error) {
                case 1 : echo $locale['674'];
                    break;
                case 2 : echo $locale['676'];
                    break;
                case 3 : echo $locale['675'];
                    break;
                case 4 : echo sprintf($locale['672'], parsebytesize($settings['download_max_b']));
                    break;
                case 5 : echo sprintf($locale['673'], str_replace(',', ' ', $settings['download_types']));
                    break;
                case 6 : echo $locale['671'];
                    break;
                case 7 : echo sprintf($locale['672a'], parsebytesize($settings['download_screen_max_b']));
                    break;
                case 8 : echo sprintf($locale['673a'], ".gif .jpg .png");
                    break;
                case 8 : echo sprintf($locale['672b'], $settings['download_screen_max_w'] . " x " . $settings['download_screen_max_h']);
                    break;
                case 10: echo $locale['671a'];
                    break;
        ...
        if (dbrows($result)) {
            ...
            echo "<td class='tbl1'><input type='text' name='download_title' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1' style='vertical-align:top;'>" . $locale['682b'] . "<span style='color:#ff0000'>*</span><br /><br />";
            echo "<span id='shortdesc_display' style='padding: 1px 3px 1px 3px; border:1px solid; display:none;'>";
            echo "<strong>255</strong>";
            echo "</span>";
            echo "</td>\n";
            echo "<td class='tbl1'><textarea name='download_description_short' cols='60' rows='4' class='textbox' onKeyDown=\"shortdesc_counter(this,'shortdesc_display',255);\" onKeyUp=\"shortdesc_counter(this,'shortdesc_display',255);\"></textarea></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1' style='vertical-align:top;'>" . $locale['682'] . "</td>\n";
            echo "<td class='tbl1'><textarea name='download_description' cols='60' rows='5' class='textbox'></textarea></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'></td><td class='tbl1'>\n";
            require_once INCLUDES . "bbcode_include.php";
            echo display_bbcodes("100%", "download_description", "submit_form") . "</td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'>" . $locale['683'] . "<span style='color:#0000cc'>*</span></td>\n";
            echo "<td class='tbl1'><input type='text' name='download_url' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1' style='vertical-align:top;'>" . $locale['684'] . "<span style='color:#0000cc'>*</span></td>\n<td class='tbl1' style='vertical-align:top;'>\n";
            echo "<input type='file' name='download_file' class='textbox'/><br />\n";
            ...
            echo "</td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1' style='vertical-align:top;'>" . $locale['686'] . "</td>\n<td class='tbl1' style='vertical-align:top;'>\n";
            echo "<input type='file' name='download_image' class='textbox'/><br />\n";
            ...
            echo "</td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'>" . $locale['687'] . "</td>\n";
            echo "<td class='tbl1'><select name='download_cat' class='textbox'>\n" . $opts . "</select></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'>" . $locale['688'] . "</td>\n";
            echo "<td class='tbl1'><input type='text' name='download_license' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'>" . $locale['689'] . "</td>\n";
            echo "<td class='tbl1'><input type='text' name='download_os' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'>" . $locale['690'] . "</td>\n";
            echo "<td class='tbl1'><input type='text' name='download_version' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'>" . $locale['691'] . "</td>\n";
            echo "<td class='tbl1'><input type='text' name='download_homepage' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'>" . $locale['692'] . "</td>\n";
            echo "<td class='tbl1'><input type='text' name='download_copyright' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td class='tbl1'>" . $locale['693'] . "</td>\n";
            echo "<td class='tbl1'><input type='text' name='download_filesize' id='download_filesize' class='textbox'/></td>\n";
            echo "</tr>\n<tr>\n";
            echo "<td align='center' colspan='2' class='tbl'><br />\n";
