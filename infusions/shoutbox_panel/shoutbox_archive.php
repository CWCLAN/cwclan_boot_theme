...
if (iMEMBER || $shout_settings['guest_shouts'] == "1") {
	...
	echo "<textarea name='archive_shout_message' rows='4' cols='50' class='textbox' onfocus=\"if(this.value=='')this.value='';\" onblur=\"if(this.value=='')this.value=='';\" onKeyDown=\"textCounter(this,'count_display',200);\" onKeyUp=\"textCounter(this,'count_display',200);\">".$archive_shout_message."</textarea><br />\n";
	echo "<div style='text-align:center'>".display_bbcodes("100%", "archive_shout_message", "archive_form", "smiley|b|i|u|url|color|lmgtfy")."</div>\n";
	if (iGUEST) {
