...
if ($in_forum) {
    if ((stristr($url, $places['index']) && $options['forum_panel'] && !(!$options['top_posters'] && !$options['forum_stats'] && !$options['user_stats'])) ||
            (stristr($url, $places['index2']) && $options['forum_panel'] && !(!$options['top_posters'] && !$options['forum_stats'] && !$options['user_stats']))) {
        //General Stats
        ...
        closetable();
                ...
                (stristr($url, $places['thread1']) && $options['similar_threads']) ||
                (stristr($url, $places['thread2']) && $options['similar_threads'])) {
        ...
        if ($thread_id) {
            ...
            ((stristr($url, $places['profile2']) && $options['profile_panel'] && isset($_GET['lookup'])))) {
