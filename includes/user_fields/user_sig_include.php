...
if ($profile_method == "input") {
    ...
    echo "<textarea id='user_sig' name='user_sig' rows='5' class='textbox'>" . $user_sig . "</textarea><br />\n";
    echo display_bbcodes("100%", "user_sig", "inputform", "smiley|b|i|u||center|small|url|mail|img|color");
    echo "</td>\n</tr>\n";
