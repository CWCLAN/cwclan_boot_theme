...
"onmouseover"		=>	"",
"onmouseout"		=>	"",
"html_start"		=>	"<div id='bbcode_color_map_".$textarea_name."' class='tbl1 bbcode-popup' style='display:none;position:absolute;' onclick=\"overlayclose('bbcode_color_map_".$textarea_name."');\">",
